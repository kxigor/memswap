...
file_names = ['./result/2/memswap_xor64.out', './result/2/memswap_xor32.out', './result/2/memswap_tmp32.out', './result/2/memswap_tmp64.out', './result/2/memswap_xor08.out', './result/2/memswap_tmp08.out']
...
plt.savefig('./graphs/test1.png', dpi=300)